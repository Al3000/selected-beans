...
import al3000.selectedbeans.OnBeforeResponseSent;
...
@Administrator
@User
@OnBeforeResponseSent
public class MultiRoleSingleFunctionBean implements Function<RequestModel, RequestModel> {
    @Override
